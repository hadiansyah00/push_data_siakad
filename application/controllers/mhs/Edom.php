...
class Edom extends CI_Controller
{
	...
	public function praktik()
	{
		...
		$data['semester'] = $this->db->get('matakuliah')->row_array();
		//tampil data KRS berdasarkan sessi login mhs
		$data['praktik'] = $this->KrsModel->viewPraktik($mhs['id_mahasiswa'], $ta['id_ta']);
		$data['setting_edom'] = $this->db->get('krs')->row_array();
		// $this->load->view('mhs/templates/header', $data);
		$this->load->view('mhs/edom/praktik-mhs', $data);
		// $this->load->view('mhs/templates/footer');
	}
	public function teori()
	{
		...
		$data['setting_edom'] = $this->db->get('krs')->row_array();
		// $this->load->view('mhs/templates/header', $data);
		$this->load->view('mhs/edom/teori-mhs', $data);
		// $this->load->view('mhs/templates/footer');
	}
}
