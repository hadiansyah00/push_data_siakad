...
class Jadwal_uap extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['judul'] = 'Akademik';
		$data['subJudul'] = 'Jadwal UAP';

		$data['tahun'] = $this->TaModel->getAktif()->result();
	
		$data['jadwal'] = $this->JadwaluapModel->getDataUap()->result();
	...
	public function insert()
	{
		...
		if ($this->input->server('REQUEST_METHOD') === 'POST') {
			...
			$this->MahasiswaModel->insertData('jadwal_uap', $data);
	...
	public function delete() {
			...
			$delete = $this->JadwaluapModel->delete_data_uap($id_jadwal);
