        ...
        <div class="container container-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo site_url('mhs/Evaluasi_mhs/simpan_dosen_2'); ?>"
                        ...
                        <div class="container">
                            <div class="text-center">
                                <strong>
                                    <p>"Segala saran dan jawaban yang Anda berikan akan dijaga kerahasiaannya oleh UPMI.
                                        Kepercayaan Anda sangatlah berharga bagi kami dan akan kami jaga dengan penuh
                                        keamanan dan
                                        rahasia."
                                    </p>
                                </strong>
