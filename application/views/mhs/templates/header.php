...
<body>
			...
			<nav class="nav-menu">
				<ul>
					...
					<li><?php
						...
						if ($mhs['status'] == 0) { ?>
								<a href="" data-toggle="modal" data-target="#ModalVerfikasiBauk"><i class="bx bx-file-blank"></i> <span>Kartu Rencana Studi(KRS)</span></a>
						<?php } else { ?>
					...
					<li><?php
						...
						<a href="" data-toggle="modal" data-target="#ModalVerfikasiBauk"><i class="bx bx-file"></i> <span> Kartu Hasil Studi(KHS) </span></a>
						<?php } else { ?>
					...
					<li>
						...
						if ($mhs['status_uts'] == 0) { ?>
						<a href="" data-toggle="modal" data-target="#ModalVerfikasiBauk"><i class="bx bx-file-blank"></i> <span>Jadwal UTS</span></a>
						<?php } else { ?>
                  ...
                  <?php if ($mhs['kelas_mhs'] == 0){ ?>
					<li>
						...
						if ($mhs['status_uas'] == 0) { ?>
						<a href="" data-toggle="modal" data-target="#ModalVerfikasiBauk"><i class="bx bx-file"></i> <span>Jadwal UAS </span></a>
						<?php } else { ?>
					...
					<li>
						<?php
						if ($mhs['status_uts'] == 0) { ?>
						<a href="" data-toggle="modal" data-target="#ModalVerfikasiBauk"><i class="bx bx-file-blank"></i> <span>Jadwal UAS</span></a>
						<?php } else { ?>
							<a href="<?php echo base_url('mhs/jadwaluas_karyawan'); ?>"><i class="bx bx-file"></i> <span>Jadwal UAS</span></a>
						<?php } ?>
					</li>
					<?php } ?>
					<li>
						...
						<a href="" data-toggle="modal" data-target="#ModalVerfikasiBauk"><i class="bx bx-file-blank"></i> <span>Nilai UTS</span></a>
						<?php } else { ?>
					...
					<li>
						...
						<a href="" data-toggle="modal" data-target="#ModalVerfikasiBauk"><i class="bx bx-file"></i> <span> Nilai UAS </span></a>
						<?php } else { ?>
							<a href="<?php echo base_url('mhs/NilaiUas'); ?>"><i class="bx bx-file-blank"></i> <span> Nilai UAS </span></a>
						<?php } ?>
					</li>
					<li>
					 <a href="<?php echo base_url('mhs/Nilai_akhir'); ?>"><i class="bx bx-file-blank"></i> <span> Nilai Akhir </span></a>
					</li>
					
					<li>
						<?php
						if ($mhs['status_pra_uap'] == 0) { ?>
						<a href="" data-toggle="modal" data-target="#ModalVerfikasiBauk"><i class="bx bx-file"></i> <span> Jadwal Pra UAP </span></a>
						<?php } else { ?>
							<a href="<?php echo base_url('mhs/Jadwalprauap'); ?>"><i class="bx bx-file-blank"></i> <span> Jadwal Pra UAP </span></a>
						<?php } ?>
					</li>
					<li>
						<?php
						if ($mhs['status_uap'] == 0) { ?>
						<a href="" data-toggle="modal" data-target="#ModalVerfikasiBauk"><i class="bx bx-file"></i> <span> Jadwal UAP </span></a>
						<?php } else { ?>
							<a href="<?php echo base_url('mhs/Jadwaluap'); ?>"><i class="bx bx-file-blank"></i> <span> Jadwal UAP </span></a>
						<?php } ?>
					</li>
					<li><?php
						if ($mhs['status_nilai_khs'] == 0) { ?>
						<a href="" data-toggle="modal" data-target="#ModalVerfikasiBauk"><i class="bx bx-file"></i> <span> Transkrip Nilai</span></a>
						<?php } else { ?>
	...
	<main id="main">
		...
		<div class="modal fade" id="exampleModalKRS" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        	...
        	<div class="modal fade" id="exampleModalEdom" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel"></h5>
					...
					<div class="modal-body">
						<table>
							<tr>
								...
								<th>
									<b>
										<h3>Mohon Maaf Saat ini EDOM Sedang dalam pengembangan</h3>
									</b>
								</th>
							</tr>
						</table>
						<h5 style="text-align: center;">Terimakasih <b>
								<font color="red">  Salam Team ICT</font>
								</font>
							</b></h5>
					</div>
				</div>
		...
		<div class="modal fade" id="ModalVerfikasiBauk" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel"></h5>
					...
					<h2 class="text-center">Cek Administrasi / Verfikasi Pembayaran ke <font color="red"> BAUK!</font></h2>
									<hr>
					<h1 class="text-center">Halaman tidak ditemukan</h1>
					<hr>
						<h6 style="text-align: center;"> Silahkan, Untuk Menghubungi pihak <b>
