...
<div class="container">
	...
	<br>
	<p> <a href="<?php echo base_url('mhs/Jadwaluap/print_uap/' . $mhs['id_mahasiswa']); ?>" target="_blank" class="btn btn-sm btn-success"><i class="icofont-print"></i> Print UAP</a>
	</p>
				...
				<tbody>
					...
					foreach ($jadwal as $row) { ?>
								...
								<tr>
									...
									<td><?php echo format_indo($row->tanggal_uap, date('d-m-y')); ?></td>
								</tr>
							<?php } ?>
				</tbody>
			</table>
