...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Evaluasi Dosen Mahasiswa Praktik Dosen 2</h1>
        ...
        <div class="section-body">
            ...
            <div class="row">
                ...
                <form id="evaluasiForm" method="post"
                    action="<?php echo site_url('mhs/Evaluasi_prak/simpan_dosen_2'); ?>">
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Edom Praktikum Berhasil disubmit!',
                            icon: 'success',
                            ...
                            window.location.href =
                                '<?php echo site_url('mhs/edom/praktik'); ?>';
                        });
                    },
