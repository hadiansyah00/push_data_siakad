                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
									...
									foreach ($praktik as $row) {
										...
										?>
                                            <?php
										$link_kuesioner = site_url('mhs/Evaluasi_prak/mulaip/' . $row->id_krs_prak . '/' . $pengajar_2);
										$link_kuesioner_2 = site_url('mhs/Evaluasi_prak/mulai_2/' . $row->id_krs_prak . '/' . $pengajar_1);
										?>
                                            <?php
