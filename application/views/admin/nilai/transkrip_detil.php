<div class="static-table-area mg-b-15">
	<div class="container-fluid">
					...
					<div class="sparkline10-list shadow-reset mg-t-30">
						...
						<div class="sparkline10-graph">
							...
							<tr>
								...
								<th colspan="8" align="center"> IPS </th>
								<th><strong> <?php echo number_format($hasil=$grand_tot2 / $sks, 2); ?></strong></th>
							</tr>
		...
		<p>
		    <b>
		        &nbsp;&nbsp;IPK : 	<?php echo number_format (($grand_tot1 + $grand_tot2 + $grand_tot3 + $grand_tot4 + $grand_tot5 + $grand_tot6 + $grand_tot7 + $grand_tot8) / $sks2, 2 ); ?>
