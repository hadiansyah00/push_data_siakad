				...
				<div class="sparkline8-list shadow-reset">
					<div class="sparkline8-hd">
						<div class="main-sparkline8-hd">
							<h1>Data Input Nilai Mahasiswa UTS</h1>
					...
					<div class="sparkline8-graph">
						<div class="datatable-dashv1-list custom-datatable-overright">
							...
							<form method="post" action="<?php echo base_url('admin/nilai/input_nilai_aksi_uts/' . $matkul['kd_mk']); ?>">
										...
										foreach ($mahasiswa as $row) { ?>
											<tr>
												...
												<td><input type="hidden" name="id_krs[]" value="<?php echo $row->id_krs; ?>">
													<input style="width: 50px;" type="text" maxlength="5" name="nilai_uts[]" " value=" <?php echo $row->nilai_uts; ?>">
												<?php } ?></td>
