                    ...
                    <div class="sparkline8-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <form method="post"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input style="width: 40px;" type="text" name="nilai[]"
                                                    onkeydown="upperCaseF(this)" maxlength="2"
                                ...
                                <h5>Sebelum pindah ke page / row selanjutnya nilai harus disimpan (Save) terlebih agar
                                    nilai tidak hilang </h5>
