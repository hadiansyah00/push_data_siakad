...
<body>
    ...
    <div class="container">
        <div class="container-fluid">
            <div class="row">
                <div class="center"><img style="width: 700px;"
                        src="<?php echo base_url('assets/images/uploads/' . $mhs['header_baak']); ?>"></div>
                <h4 class="text-center"> <strong>Kartu Rencana Studi</strong></h4>
                <h6 class="text-center padding-20">Tahun Ajaran - <?php echo $tahun['ta']; ?>
                    (<?php echo $tahun['semester']; ?>)</h6>
                <br>
