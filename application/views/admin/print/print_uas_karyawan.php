...
<head>
	...
	<meta charset="utf-8" />
	<title>Kartu UAS Mahasiswa</title>
...
<body>
	...
	<div class="container">
		<div class="container-fluid">
			<div class="row">
				<div class="center"><img style=" width: 100px;" src="<?php echo base_url('assets/img/logo_sbh.png'); ?> ">
					<h4 class="text-center">Kartu Ujian Akhir Semester  <br class="padding-0"> <?php echo $tahun['ta']; ?> (<?php echo $tahun['semester']; ?>)</h4></div>
				...
				<table class="table table-bordered">
					<thead class="table-light">
						<tr>
							...
							<!--<th style="width: 10px;" class="text-center" rowspan="2">Kode MK</th>-->
							...
							<th class="text-center"rowspan="4">Paraf</th>
							...
							<?php if ($row->semester == $tahun['semester']) { ?>
								<?php if ($row->smt == $mhs['semester']) {
									...
									<tr>
										...
										<td class="align :center width:110px"><?php echo format_indo($row->tgl_uas); ?> <?php echo $row->jam_uas; ?>
										<td> &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
										 &nbsp;&nbsp; &nbsp;&nbsp;</td>
										<td>&nbsp;&nbsp; &nbsp;&nbsp;</td>
