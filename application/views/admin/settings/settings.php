					...
					<div class="sparkline8-hd">
						<div class="main-sparkline8-hd">
							...
							<div class="sparkline8-outline-icon">
								<span title="Refresh"><a href="<?php echo base_url('admin/settings'); ?>" class="btn-sm btn-warning"><i class="fa fa-refresh"></i></a>
								</span>
							...
							<table id="table" data-toggle="table">
								...
								<tbody>
									<tr>
										...
										<td>
											<?php if ($status['status'] == 0) { ?>
												<a href="<?php echo base_url('admin/settings/setKrs/' . $status['id_setkrs']); ?>" class='btn-success btn-sm'>
													<i class='ace-icon fa fa-check bigger-120'></i>
													Aktifkan
												</a>
											<?php } else {  ?>
												<a href='<?php echo base_url('admin/settings/setKrsN/' . $status['id_setkrs']); ?>' class='btn-warning btn-sm'>
								...
								<tbody>
									...
									foreach ($ta as $row) : ?>
										<tr>
											...
											<td>
												<?php if ($row->status == 0) { ?>
													<a class="btn-sm btn-success" href="<?php echo base_url('admin/settings/setTa/' . $row->id_ta); ?>"><i class="fa fa-check"></i> Aktifkan</a>
													<?php if ($status['hide_btn_del'] == 0) {
													} else { ?>
														<a class="btn-sm btn-danger" href="<?php echo base_url('admin/settings/delete/' . $row->id_ta); ?>" onclick="return confirm('Yakin Akan Di Hapus??');"><i class="fa fa-trash"></i></a>
													<?php } ?>
												<?php } ?>
											</td>
										</tr>
					...
					<div class="sparkline8-hd">
						<div class="main-sparkline8-hd">
							...
							<div class="sparkline8-outline-icon">
								...
								<span title="Hide Button" class="sparkline8-collapse-link"><i class="fa fa-chevron-up"></i></span>
								<span title="Close Table" class="sparkline8-collapse-close"><i class="fa fa-times"></i></span>
							</div>
						</div>
					</div>
							...
							<table id="table" data-toggle="table">
								...
								<tbody>
									<tr>
										...
										<td>
											<?php if ($status['hide_btn_del'] == 0) { ?>
												<a href="<?php echo base_url('admin/settings/setUnhide/' . $status['id_setkrs']); ?>" class='btn-success btn-sm'>
													<i class='ace-icon fa fa-check bigger-120'></i>
													Aktifkan
												</a>
											<?php } else {  ?>
												<a href='<?php echo base_url('admin/settings/setHide/' . $status['id_setkrs']); ?>' class='btn-warning btn-sm'>
													<i class='ace-icon fa fa-exclamation-triangle bigger-120'></i>
													Tidak-Aktif
												</a>
											<?php } ?>
