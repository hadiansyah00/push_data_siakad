										...
										<tr>
											...
											<td>
												<?php if ($row->status_edom == 0) { ?>
													<a data-toggle="tooltip" data-placement="top" title="Klik Untuk Mengaktifkan" class="btn-sm btn-danger" href="<?php echo base_url('admin/evaluasi/setEdomAktGz/' . $row->id_mahasiswa); ?>"><i class="ace-icon fa fa-exclamation-circle bigger-120"> Blok</i></a>
													</a>
													</a>
												<?php } else {  ?>
													<a data-toggle="tooltip" data-placement="top" title="Klik Untuk Blokir" href='<?php echo base_url('admin/evaluasi/setEdomOffGz/' . $row->id_mahasiswa); ?>' class='btn-success btn-sm'>
