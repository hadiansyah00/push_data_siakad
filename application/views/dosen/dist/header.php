...
if ($this->uri->segment(2) == "layout_transparent") {
  $this->load->view('dosen/dist/layout-2');
  $this->load->view('dosen/dist/sidebar-2');
}elseif ($this->uri->segment(2) == "layout_top_navigation") {
  $this->load->view('dosen/dist/layout-3');
  $this->load->view('dosen/dist/navbar');
  ...
  $this->load->view('dosen/dist/layout');
  $this->load->view('dosen/dist/sidebar');
}
?>