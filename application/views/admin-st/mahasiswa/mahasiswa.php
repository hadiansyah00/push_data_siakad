					...
					<div class="sparkline8-hd">
						<div class="main-sparkline8-hd">
							...
							<div class="sparkline8-outline-icon">
								...
								<span title="Refresh"><a href="<?php echo base_url('admin/Mahasiswa'); ?>" class="btn-sm btn-warning"><i class="fa fa-refresh"></i></a>
								</span>
									...
									foreach ($mahasiswa as $row) { ?>
										...
										<tr>
											...
											<td><?php echo $row->kelas; ?></td>
												<td> <a  class="link"href="<?php echo base_url('admin/Mahasiswa/upStatus/' . $row->id_mahasiswa); ?>"> 
												...
												<td > <a  class="btn-sm btn-primary" href="<?php echo base_url('admin/Mahasiswa/updateDospem/' . $row->id_mahasiswa); ?>"><i class="fa fa-edit"> &nbsp; </i><?php echo $row->nama_dosen; ?></a></td>
										
											<td>
												<a title="Detil Mahasiswa" class="btn-sm btn-success" href="<?php echo base_url('admin/Mahasiswa/view_mhs/' . $row->id_mahasiswa); ?>"><i class="fa fa-eye"></i></a>

												<a title="Update Mahasiswa" class="btn-sm btn-warning" href="<?php echo base_url('admin/Mahasiswa/updatePass/' . $row->id_mahasiswa); ?>"><i class="fa fa-edit"></i></a>
												<?php $btn = $this->db->get('set_krs')->row_array();
												if ($btn['hide_btn_del'] == 0) {
												} else { ?>
													<a title="Hapus Data" class="btn-sm btn-danger" href="<?php echo base_url('admin/Mahasiswa/delete/' . $row->id_mahasiswa); ?>" onclick="return confirm('Yakin Akan Di Hapus??');"><i class="fa fa-trash"></i></a>
												<?php } ?>
											</td>
										</tr>
									<?php } ?>
							...
							<form action="<?php echo base_url('admin/Mahasiswa/insert'); ?>" method="post">
								...
								<div class="form-group-inner">
									<div class="row">
										...
										<div class="col-lg-8">
											<input type="text" class="form-control" name="nama_mhs" placeholder="Input Nama" required="">
										</div>
									</div>
								</div>
								<div class="form-group-inner">
										...
										<div class="col-lg-8">
											<select name="jurusan" class="form-control">
												...
												foreach ($mahasiswa as $mhs) : ?>
													<option value="<?php echo $mhs->kd_jurusan; ?>"><?php echo $mhs->jurusan; ?></option>
												<?php endforeach; ?>
											</select>
										</div>
									</div>
