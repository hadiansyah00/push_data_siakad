                    ...
                    <div class="sparkline8-hd">
                        <div class="main-sparkline8-hd">
                            ...
                            <div class="sparkline8-outline-icon">
                                <span title="Refresh"><a href="<?php echo base_url('admin/Jadwaluts'); ?>"
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="jadwaluts">Jadwal UTS</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $i = 1;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn-sm btn-primary"
                                                href="<?php echo base_url('admin/Jadwaluts/index_jadwal/' . $row->kd_jurusan . '/'); ?>"><i
