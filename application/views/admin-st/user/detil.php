...
<div class="menu-animate-list shadow-reset mg-b-15 menu-list-wrap">
    ...
    <ul class="nav nav-tabs custom-menu-wrap custom-menu-wrap-st">
        ...
        <li><a href="<?php echo base_url('admin/User'); ?>"><i class="fa fa-backward"></i> Kembali</a>
        </li>
    </ul>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="all-form-element-inner">
                            <form action="<?php echo base_url('admin/User/update/'.$users['id']);?>" method="post">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="all-form-element-inner">
                            <form action="<?php echo base_url('admin/User/updatePass/'.$users['id']);?>" method="post">
