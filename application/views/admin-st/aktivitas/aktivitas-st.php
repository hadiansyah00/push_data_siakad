                            ...
                            <div class="table-responsive">
								...
								foreach ($list as $row) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $i++; ?></td>
                                            <td><?php echo $row->list_perbaikan; ?></td>
                                            <td><?php echo format_indo($row->tgl); ?></td>
                                            <td><?php echo time_elapsed_string($row->tgl_insert); ?></td>
                                            <td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data List Perbaikan</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="pertanyaan">List Perbaikan</label>
                                <textarea type="text" class="form-control" name="list_perbaikan"
                                    placeholder="list_perbaikan" required></textarea>
                                <div class="invalid-feedback">
                                    Please provide a valid name Perbaikan
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="pertanyaan">Tanggal</label>
                                <input type="date" class="form-control" name="tgl" required></input>
                            </div>
...
$(document).ready(function() {
    $('#formTambahPertanyaan').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('admin/Aktivitas/insert'); ?>',
            data: formData,
            dataType: 'json',
