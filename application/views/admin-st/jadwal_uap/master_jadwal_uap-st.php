				...
				<div class="sparkline8-list shadow-reset">
					<div class="sparkline8-hd">
						<div class="main-sparkline8-hd">
							<h1>Tabel Jadwal UAP (Ujian Akhir Program)</h1>
							<div class="sparkline8-outline-icon">
								...
								<span title="Refresh"><a href="<?php echo base_url('admin/Jadwal_uap'); ?>" class="btn-sm btn-warning"><i class="fa fa-backward"></i></a>
								</span>
							...
							<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-toolbar="#toolbar">
								<thead>
									<tr>
										...
										<th data-field="jam_uap">Jam UAP</th>
										<th data-field="tgl_uap">Tanggal UAP</th>
								...
								<tbody>
									...
									foreach ($jadwal as $row) { ?>
											<tr>
												...
												<td><?php echo $row->jam_uap; ?></td>
												<td><?php echo format_indo($row->tanggal_uap); ?></td>
												<?php $btn = $this->db->get('set_krs')->row_array();
												if ($btn['hide_btn_del'] == 0) {
												} else { ?>
													<td>
														...
														<a class="btn-sm btn-danger" href="<?php echo base_url('admin/Jadwal_uap/delete/' . $row->id); ?>" onclick="return confirm('Yakin Akan Di Hapus??');"><i class="fa fa-trash"></i></a>
													</td>
												<?php } ?>
											</tr>
										<?php } ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header header-color-modal bg-color-1">
				<h4 class="modal-title">Form Tambah Jadwal UAP</h4>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="all-form-element-inner">
						    ...
						    <form  action="<?php echo base_url('admin/Jadwal_uap/insert/' . $row->kd_jurusan . '/'); ?>" method="post">
							<div class="form-group-inner">
								<div class="form-group-inner">
									<div class="row">
    										<div class="col-lg-4">
    											<label class="login2 pull-left pull-left-pro">Nama Ujian </label>
    										</div>
									    	<div class="col-lg-8">
    											<select name="nama" class="form-control">
    											<option valued isabled> --Nama Ujian-- </option>
    												<option value="Ujian Akhir Program (UAP) Tulis">Ujian Akhir Program (UAP) Tulis</option>
    												<option value="Ujian Akhir Program (UAP) Praktik">Ujian Akhir Program (UAP) Praktik</option>
    											</select>
									    	</div>
								    	</div>
							         </div>             
						        ...
						        <div class="form-group-inner">
									<div class="row">
    										<div class="col-lg-4">
    											<label class="login2 pull-left pull-left-pro">Jam UAP </label>
    										</div>
									    	<div class="col-lg-8">
    											<input type="text" name="jam_uap" class="form-control" placeholder="Masukan Jam" required="">
									    	</div>
								    	</div>
							         </div>             
						        </div>
								...
								<div class="form-group-inner">
									<div class="row">
										<div class="col-lg-4">
											<label class="login2 pull-left pull-left-pro">Tanggal UAP</label>
										</div>
										<div class="col-lg-8">
											<input type="date" name="tanggal_uap" class="form-control" required="">
										</div>
									</div>
