    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data Jadwal UAP </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <select name="nama" class="form-control">
                                    ...
                                    <option value="Ujian Akhir Program (UAP) Tulis">Ujian Akhir Program (UAP) Tulis
                                    </option>
                                    <option value="Ujian Akhir Program (UAP) Praktik">Ujian Akhir Program (UAP) Praktik
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Jam UAP</label>
                                <input type="text" name="jam_uap" class="form-control" placeholder="Masukan Jam"
                                    required="">
...
$(document).ready(function() {
    ...
    $('#editUtsForm').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('admin/Jadwal_uap/update'); ?>',
            data: formData,
            dataType: 'json',
            success: function(response) {
                if (response.status === 'success') {
