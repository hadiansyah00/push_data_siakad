				...
				<div class="sparkline8-list shadow-reset">
					...
					<div class="sparkline8-graph">
						<div class="datatable-dashv1-list custom-datatable-overright">
							...
							<form method="post" action="<?php echo base_url('admin/nilai/input_nilai_aksi/' . $matkul['kd_mk']); ?>">
										...
										foreach ($mahasiswa as $row) { ?>
											<tr>
												...
												<td>
														...
														<input style="width: 40px;" type="text" name="nilai[]" onkeydown="upperCaseF(this)"  maxlength="2"  value="<?php echo $row->nilai; ?>">
