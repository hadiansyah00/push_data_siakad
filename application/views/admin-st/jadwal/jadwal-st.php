								...
								foreach ($pdf as $row) { ?>
                                        <tr>
                                            ...
                                            <td> <button type="button" class="btn btn-danger btn-sm btn-delete"
                                                    data-id="<?php echo $row->id_jadwal_pdf; ?>">
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
                ...
                <div class="modal-body">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="keterangan_berkas" accept=".pdf">
...
$(document).ready(function() {
    $('#uploadForm').submit(function(e) {
        ...
        $.ajax({
            url: '<?php echo base_url('admin/jadwal/do_upload'); ?>',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
                ...
                if (response.success) {
                    ...
                    swal("Success", response.message, "success").then((value) => {
                        ...
                        window.location.href =
                            '<?php echo base_url('admin/Jadwal'); ?>';
                    });
                } else {
...
$(document).on('click', '.btn-delete', function() {
    var id_jadwal_pdf = $(this).data('id');

    // Include CSRF token dalam data
    var formData = {
        id_jadwal_pdf: id_jadwal_pdf,
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url('admin/jadwal/delete'); ?>',
                data: formData,
                dataType: 'json',
                success: function(response) {
