							...
							<div class="row">
								<div class="col-lg-12">
									<div class="all-form-element-inner">
										<form class="form-horizontal form" method="post" action="<?php echo base_url('admin/Mahasiswa/updatePass'); ?>">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<input type="text" name="username" value="<?php echo $users['username']; ?>" class="form-control" disabled="">
												</div>
											</div>
